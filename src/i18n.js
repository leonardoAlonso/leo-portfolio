...
const resources = {
  en: {
    translation: {
      ...
      "experience": "I'm proud to have colaborate with some awesome companies:",
      "footer": "Living, learning, & leveling up one day at a time.",
      "blog_title": "My latest articles",
      "blog_subtitle": "Do you want to learn something about what I know? Here are some of my latest articles",
      "read_more": "Leer",
    }
  },
  es: {
    translation: {
      ...
      "experience": "Estoy orgulloso de colaborar con algunas empresas increibles",
      "footer": "Vivo, Aprendo y Mejoro un día a la vez",
      "blog_title": "Mis ultimos articulos.",
      "blog_subtitle": "¿Te interesa aprender algo sobre lo que yo se? Aqui hay algunos de mis ultimos articulos",
      "read_more": "Leer",
    }
  }
};
